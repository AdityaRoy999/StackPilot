      ...
      >
        ...
        <div className="w-full max-w-7xl mx-auto px-2 sm:px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-stretch h-auto lg:h-[calc(100vh-195px)] lg:min-h-[380px] lg:max-h-[530px]">
            {/* Left Box: Video Container with feature border radius */}
            <div className="w-full h-52 xs:h-64 sm:h-72 lg:h-full">
              <div
                onClick={() => setIsEnlarged(true)}
                className="relative w-full h-full overflow-hidden bg-black shadow-2xl select-none cursor-pointer border border-zinc-800/80 transition-all duration-300 hover:scale-[1.005] group flex items-center justify-center"
            ...
            {/* Right Box: Bento Card with feature border radius */}
            <div className="w-full h-auto lg:h-full">
              <div
                className="w-full h-full border border-zinc-800/80 bg-zinc-950/90 backdrop-blur-2xl p-5 sm:p-6 lg:p-7 flex flex-col justify-between gap-4 shadow-2xl select-none keep-sans transition-all duration-300"
                style={{ borderRadius: `${activeFeature.borderRadius}px` }}
              >
