...
function isLightColor(color: string): boolean {
  ...
  const blue = parseInt(hex.slice(4, 16), 16);
    ...
    <div
      ...
      style={{
        ...
        boxShadow: lightSurface
          ...
          : 'rgba(0,0,0,0.2) 0 1px 2px, rgba(0,0,0,0.15) 0 4px 12px, rgba(0,0,0,0.25) 0 12px 32px',
      }}
    >
      ...
      <div className="flex flex-col relative z-[1] w-full h-full min-w-0">
        {children}
      </div>
    </div>
  );
