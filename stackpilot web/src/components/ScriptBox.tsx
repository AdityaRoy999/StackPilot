...
type Tab = 'bash' | 'powershell' | 'docker' | 'cli';
...
const SCRIPTS: ScriptOption[] = [
  ...
  },
  {
    ...
    command: 'powershell -ExecutionPolicy Bypass -c "irm https://raw.githubusercontent.com/AdityaRoy999/StackPilot/main/scripts/install.ps1 | iex"',
  },
  {
    id: 'docker',
  ...
  },
  {
    id: 'cli',
    label: 'Python CLI',
    command: 'pip install stackpilot && stackpilot test https://your-app.com',
  },
];
  ...
  return (
    <div className="w-full max-w-2xl mx-auto mt-8">
      ...
      <div className="flex items-center justify-between gap-2 mb-2">
        <div className="inline-flex items-center p-1 rounded-lg border border-zinc-800/80 bg-zinc-900/60 text-xs font-mono">
          {SCRIPTS.map((script) => (
            <button
              key={script.id}
      ...
      <div className="relative rounded-xl border border-zinc-800/90 bg-zinc-950 p-4 sm:p-5 font-mono text-xs sm:text-sm text-left shadow-2xl">
        <div className="flex items-center gap-2 mb-3 pb-2.5 border-b border-zinc-900 text-zinc-500 text-[11px]">
        ...
        <div className="overflow-x-auto whitespace-pre select-all text-zinc-200 py-1">
      ...
      {/* Metadata */}
      <div className="mt-3 flex items-center justify-center gap-4 text-[11px] text-zinc-500 font-mono">
