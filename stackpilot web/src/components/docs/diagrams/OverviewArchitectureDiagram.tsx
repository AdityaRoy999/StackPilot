...
export const OverviewArchitectureDiagram: React.FC = () => {
  ...
  return (
    <div className="my-8 rounded-2xl border border-zinc-800/90 bg-[#18181b]/90 p-5 sm:p-6 shadow-xl space-y-6">
                    ...
                    <div
                      ...
                      className={`p-2.5 rounded-lg border transition-all cursor-pointer flex items-center justify-between gap-2 ${
                        isSelected
                          ...
                          : 'bg-black/40 border-zinc-800/70 hover:border-zinc-700 hover:bg-zinc-800/40'
                      }`}
                    >
      ...
      {/* Architectural Flow Highlights Card */}
      <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800/80 space-y-2.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-xs text-zinc-300 font-mono">
          <div className="p-2.5 rounded-lg bg-black/60 border border-zinc-800 space-y-1">
