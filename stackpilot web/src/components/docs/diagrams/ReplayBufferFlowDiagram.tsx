...
export const ReplayBufferFlowDiagram: React.FC = () => {
  ...
  return (
    <div className="my-8 rounded-2xl border border-zinc-800/90 bg-[#18181b]/90 p-5 sm:p-6 shadow-xl space-y-6">
      ...
      {/* Decision Flow Breakdown (Yes/No branches) */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800/80 space-y-2.5">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="p-2.5 rounded-lg bg-amber-950/30 border border-amber-800/40 space-y-1">
      ...
      <div className="p-4 sm:p-5 rounded-xl bg-black/80 border border-zinc-800 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="space-y-0.5">
            ...
            <p className="text-[11px] text-zinc-400">
              Drag scrubber to test instant seek into the 700-frame FIFO buffer.
            </p>
          </div>

          <div className="flex items-center gap-3 text-xs font-mono">
            <span className="px-2.5 py-1 rounded bg-zinc-900 border border-zinc-800 text-zinc-300">
              Frame: <span className="text-white font-bold">{simulatedFrame}</span> / 700
            </span>
            <span className="px-2.5 py-1 rounded bg-zinc-900 border border-zinc-800 text-zinc-300">
              Time: <span className="text-white font-bold">-{secondsAgo}s</span>
            </span>
          </div>
        </div>
